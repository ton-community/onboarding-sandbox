...
describe('OrderDeployer', () => {
    ...
    beforeAll(async () => {
        ...
        buyerSecondJettonWallet = blockchain.openContract(JettonWallet.createFromAddress(await firstJettonMinter.getWalletAddress(buyer.address)));
    });
    ...
    it('should create order', async () => {
        ...
        orderJettonWallet = blockchain.openContract(JettonWallet.createFromAddress(orderJettonWalletAddress));
    ...
    it('should partially close', async () => {
        ...
        const orderJettonWalletAddress = await secondJettonMinter.getWalletAddress(orderAddress);
        const buyerOrderJettonWallet = blockchain.openContract(JettonWallet.createFromAddress(orderJettonWalletAddress));
